<template>
  <div class="login-wrap">
    ...
    <div class="loogin-container">
      ...
      <el-form :model="sendData" class="form-wrap" ref="ruleFormRef" :rules="rules" autocomplete="off">
      ...
      <el-button class="login-btn" type="primary" :loading="loginLoading" @click="loginHandle(ruleFormRef)">登录</el-button>
    </div>
  </div>
</template>
